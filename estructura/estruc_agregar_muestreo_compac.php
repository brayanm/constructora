...
$sql= "INSERT INTO `estructura_registro_fecha`(`correlacional`, `muestra`, `fecha`, `llena` , `ensayo`) VALUES ( '$correlacion', '$muestra' , '$fecha', '1', '1')";
$sql1= "INSERT INTO `estructura_registro_fecha`(`correlacional`, `muestra`, `fecha`, `llena` , `ensayo`) VALUES ( '$correlacion', '$muestra' , '$fecha1', '0', '2')";
$sql2= "INSERT INTO `estructura_registro_fecha`(`correlacional`, `muestra`, `fecha`, `llena`, `ensayo`) VALUES ( '$correlacion', '$muestra' , '$fecha2', '0' , '3')";
$sql3= "INSERT INTO `estructura_registro_fecha`(`correlacional`, `muestra`, `fecha`, `llena`, `ensayo`) VALUES ( '$correlacion', '$muestra' , '$fecha2', '0','3')";
$sql4= "INSERT INTO `estructura_registro_fecha`(`correlacional`, `muestra`, `fecha`, `llena`, `ensayo`) VALUES ( '$correlacion', '$muestra' , '$fecha2', '0','3')";
